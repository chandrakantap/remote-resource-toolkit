 ...
 */
import * as exported from '@cksutils/remote-resource-toolkit';
 ...
 *  node -e "import('@cksutils/remote-resource-toolkit').then((mod) => console.log(JSON.stringify(Object.keys(mod), null, 2)))" > scripts/rollup/all-exports.json
 */
